...
class ExecutionRecord:
    ...
    #
    # Orthogonal to `failure_status` above, which says what went wrong with a
    # call. This says whether the call happened for real at all.
    ...
    def as_dict(self) -> dict:
        return dict(
            ...
            origin=self.origin, origin_reason=self.origin_reason,
        )
